...
ScenarioInfo = {
    ...
    size = {1024, 1024},
    reclaim = {0, 0},
    map = '/maps/BlackSunDefense-6P.v0001/BlackSunDefense-6P.scmap',
    save = '/maps/BlackSunDefense-6P.v0001/BlackSunDefense-6P_save.lua',
    script = '/maps/BlackSunDefense-6P.v0001/BlackSunDefense-6P_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
                {
